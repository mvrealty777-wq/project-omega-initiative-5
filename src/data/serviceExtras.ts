...
export const serviceExtras: Record<string, ServiceExtra> = {
  hammam: {
    ...
    testimonials: [
      ...
      { name: "Ольга К.", role: "Частный клиент, Москва", avatar: "ОК", stars: 5, quote: "Хамам в квартире — казалось, что невозможно, но ребята сделали компактный вариант с полноценным парогенератором. Соседи не жалуются, гидроизоляция на высоте." },
      { name: "Виктор С.", role: "Владелец фитнес-клуба", avatar: "ВС", stars: 5, quote: "Заказывали коммерческий хамам для клуба — выдержал уже больше года ежедневной нагрузки без единой поломки. Клиенты в восторге от атмосферы." },
      { name: "Марина Т.", role: "Частный клиент, Сочи", avatar: "МТ", stars: 5, quote: "Хамам с золотой мозаикой и куполом получился именно таким, каким мы его представляли по 3D-проекту. Сроки не сдвинули ни на день, спасибо команде!" },
    ],
