    ...
    <section className="py-10 sm:py-12 lg:py-14 px-4 sm:px-6 lg:px-8 section-glass-tint">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="rounded-3xl border border-border bg-white shadow-xl overflow-hidden">
          {/* Header */}
          <div className="hidden sm:grid grid-cols-[1fr_180px] gap-4 px-6 py-4 text-white bg-gradient-to-br from-green-700 to-green-900">
            <div className="font-bold text-sm uppercase tracking-wide font-heading">Вид работ</div>
            <div className="font-bold text-sm uppercase tracking-wide text-right font-heading">Сроки</div>
          </div>
          ...
          {rows.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-3.5">
                <span className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-primary/10">
              ...
              <div className="sm:text-right pl-[3.25rem] sm:pl-0">
                <span className="inline-flex items-center gap-1.5 text-sm font-bold px-3.5 py-1.5 rounded-full text-primary bg-primary/10 font-heading">
