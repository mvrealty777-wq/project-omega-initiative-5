...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-10 sm:py-12 lg:py-14 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
      ...
      {/* Decorative glow */}
      <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full blur-3xl opacity-20 pointer-events-none bg-green-600" />
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full blur-3xl opacity-10 pointer-events-none bg-green-600" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="relative">
              <img
                ...
                className="w-44 h-44 sm:w-52 sm:h-52 rounded-full object-cover border-4 shadow-2xl border-green-500/60"
              />
              <span className="absolute bottom-3 right-3 w-6 h-6 rounded-full border-4 animate-pulse bg-green-500 border-[hsl(220_25%_11%)]" />
            </div>
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight mb-8">
              ...
              <span className="text-green-400">бесплатной консультации</span>
            </h2>
            ...
            <div className="rounded-2xl p-6 sm:p-7 border border-white/10"
              ...
              {sent ? (
                <div className="flex items-center gap-4 py-2">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-green-900/30">
