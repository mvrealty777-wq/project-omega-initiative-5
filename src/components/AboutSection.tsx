      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
          {values.map((value, index) => (
            <div
              key={index}
              className="flex items-start gap-4 bg-white rounded-2xl p-6 border border-border shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div>
                <p className="font-bold text-lg text-foreground mb-1.5 font-heading">{value.title}</p>
        ...
        {/* Stats strip */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 rounded-2xl overflow-hidden p-6 sm:p-8 bg-gradient-to-br from-green-700 to-green-900">
          {stats.map((stat, index) => (
            <div key={index} className="relative text-center text-white flex flex-col items-center justify-center py-2">
              ...
              <div className="relative">
                <div className="text-4xl sm:text-5xl font-black mb-1 font-heading">
                  {stat.number}
                </div>
