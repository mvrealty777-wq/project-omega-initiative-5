  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute text-6xl" style={{ top: "15%", left: "8%", animationDelay: "0s" }} >🌿</div>
        <div className="absolute text-5xl animate-float" style={{ top: "20%", right: "12%", animationDelay: "2s" }}>🪷</div>
        <div className="absolute text-4xl animate-float" style={{ bottom: "25%", left: "15%", animationDelay: "1s" }}>✦</div>
        <div className="absolute text-5xl animate-float" style={{ bottom: "20%", right: "8%", animationDelay: "3s" }}>🌸</div>
      </div>

      <div className="container mx-auto text-center max-w-5xl relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 animate-fade-in-up">
          <Sparkles className="w-4 h-4 text-primary" />
          <span className="text-sm font-medium text-primary tracking-wider uppercase">Премиум СПА & Массаж в Москве</span>
        </div>
        ...
        <p className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in-up animate-delay-100 leading-relaxed">
          Профессиональный массаж, СПА-программы и уходовые процедуры для вашего тела и души. Погрузитесь в атмосферу полного расслабления.
        </p>
